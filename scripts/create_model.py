...
path = os.path.abspath(os.path.join(full_path))

bpy.ops.object.delete(use_global=False)
# Load the svg image
bpy.ops.import_curve.svg(filepath=path + "/images/layout.svg")
...
# Save the model
bpy.ops.export_mesh.stl(filepath=path + "/model/model.stl")
